...
$(document).ready(function () {
    ...
    $("#submenu_best_products").addClass("active");

    InitDT("#dtBestProduct");
});
...
function InitDT(element) {
    ...
    var e = $(element).dataTable({
        ...
        sAjaxSource: "/api/services.asmx/admin_dtBestProducts",
        fnInitComplete: function () {
            this.fnSetFilteringDelay(500);
        },
        aoColumns: [{ mDataProp: "Photo", sWidth: "10%" },
                    { mDataProp: "Name", sWidth: "20%" },
                    { mDataProp: "Quantity", sWidth: "20%" },
                    { mDataProp: "Total", sWidth: "20%" }
        ],
        aaSorting: [[2, 'desc']],
        aoColumnDefs: [{
            sClass: "text-center",
