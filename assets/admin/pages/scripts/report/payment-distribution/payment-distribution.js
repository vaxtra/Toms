...
$(document).ready(function () {
    ...
    $("#submenu_payment-distribution").addClass("active");
    InitDT("#dtPaymentDis");
    InitDateRange();
});
...
function InitDT(element) {
    ...
    var e = $(element).dataTable({
        ...
        fnRowCallback: function (nRow, aaData, dIndex, rIndex) {
            ...
            var s = "";
            s += '<span class="format-money">' + aaData.AverageSales + '</span>';
...
function InitDateRange() {
    ...
    function (start, end) {
        ...
        //FullFilter();
        InitDT_Filter("#dtPaymentDis", $(".input-mini[name=daterangepicker_start]").val(), $(".input-mini[name=daterangepicker_end]").val());
...
function InitDT_Filter(element, startDate, endDate) {
    ...
    var e = $(element).dataTable({
        ...
        bRetrieve: true,
        sPaginationType: "bootstrap",
        sAjaxSource: "/api/services.asmx/admin_dtPaymentDistribution_FilterDate",
