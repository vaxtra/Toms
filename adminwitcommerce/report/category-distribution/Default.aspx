<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="assets_admin_pages_scripts_report_category_distribution_Default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderBreadcrumb" Runat="Server">
    ...
    <li><i class="fa fa-angle-right"></i></li>
    <li>
        <a href="/adminwitcommerce/report/category-distribution/Default.aspx">Category Distribution</a>
    </li>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-book"></i>Category Distribution</div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dtCategoryDis">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Category</th>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" Runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/report/category-distribution/category-distribution.js"></script>
</asp:Content>
