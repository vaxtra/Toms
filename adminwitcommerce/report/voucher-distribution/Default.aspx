...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderBreadcrumb" runat="Server">
    ...
    <li><i class="fa fa-angle-right"></i></li>
    <li>
        <a href="/adminwitcommerce/report/voucher-distribution/Default.aspx">Voucher Distribution</a>
    </li>
</asp:Content>
        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-book"></i>Voucher Distribution</div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dtVoucherDis">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Voucher</th>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/report/voucher-distribution/voucher-distribution.js"></script>
</asp:Content>
