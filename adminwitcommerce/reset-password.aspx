<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reset-password.aspx.cs" Inherits="adminwitcommerce_reset_password" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Administrator | WITCommerce</title>
        ...
        <form id="FormReset">
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input id="Password" class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="New Password" name="Password" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Password" name="Password2" />
                </div>
            </div>
...
<![endif]-->
    ...
    <script src="/assets/admin/pages/scripts/reset-password.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
