<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="Insert.aspx.cs" Inherits="adminwitcommerce_content_post_Insert" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderBreadcrumb" Runat="Server">
    ...
    <li>
        <a href="/adminwitcommerce/content/post/">Content</a>
    </li>
    <li><i class="fa fa-angle-right"></i></li>
    <li>
        <a href="/adminwitcommerce/content/post/">Post</a>
    </li>
    <li><i class="fa fa-angle-right"></i></li>
    <li>
        <a href="#">New Post</a>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" Runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/content/post/insert.js"></script>
</asp:Content>
