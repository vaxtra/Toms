<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="Insert.aspx.cs" Inherits="adminwitcommerce_catalog_manufacturer_Insert" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderBreadcrumb" runat="Server">
    ...
    <li><i class="fa fa-angle-right"></i></li>
    <li><a href="#">New Manufacturer</a></li>
</asp:Content>
            ...
            <form class="horizontal-form" id="form_manufacturer">
                <div class="portlet">
                    <div class="portlet-title">
                        <div class="caption"><i class="fa fa-edit"></i>New Manufacturer</div>
                        <div class="actions">
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/catalog/manufacturer/insert.js"></script>
</asp:Content>
