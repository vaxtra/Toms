<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="import-inventory.aspx.cs" Inherits="adminwitcommerce_catalog_import_product_import_inventory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderBreadcrumb" runat="Server">
    ...
    <li><i class="fa fa-angle-right"></i></li>
    <li><a href="#">Import Inventory</a></li>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" runat="Server">
    <script>
        $(document).ready(function () {
            $("#submenu_import_inventory").addClass("active");
