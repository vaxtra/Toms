<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="adminwitcommerce_administration_employee_update" %>
        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-people"></i>Update Employee</div>
                    <div class="actions">
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/administration/employee/update.js"></script>
</asp:Content>
