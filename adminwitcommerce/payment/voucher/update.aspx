<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="adminwitcommerce_voucher_update" %>
        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-edit"></i>Update Voucher</div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    <input type="hidden" id="HiddenIDVoucher" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group hidden">
                                        <input type="text" name="Value" maxlength="15" class="form-control money typeAmount" value="0" />
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/payment/voucher/update.js"></script>
</asp:Content>
