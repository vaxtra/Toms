<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="adminwitcommerce_customer_customer_group_Default" %>
        ...
        <div class="col-md-12">
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption"><i class="fa fa-person"></i>Customer Group</div>
                    <div class="actions">
                        <a href="insert.aspx" class="btn backLink btn-default btn-sm"><i class="fa fa-plus"></i>&nbsp;New Customer Groups </a>
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dtCustomerGroup">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" Runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/customer/customer-group/default.js"></script>
</asp:Content>
