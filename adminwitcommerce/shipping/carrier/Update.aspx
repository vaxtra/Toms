<%@ Page Title="" Language="C#" MasterPageFile="~/adminwitcommerce/AdministratorMasterPage.master" AutoEventWireup="true" CodeFile="Update.aspx.cs" Inherits="adminwitcommerce_shipping_carrier_Update" %>
        ...
        <div class="col-md-12">
            <div class="portlet">
                ...
                <div class="portlet-body form">
                    <input type="hidden" id="HiddenIDCarrier" />
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolderJavaScript" Runat="Server">
    ...
    <script type="text/javascript" src="/assets/admin/pages/scripts/shipping/carrier/update.js"></script>
</asp:Content>
